...
export const projects:projectDetails[] = [
    {
        ...
        ,icons:[FaReact,TbFileTypeCss,SiReactrouter]
    ...
    },
    {
        ...
        ,icons:[TbApi, FaReact ,TbFileTypeCss, SiFramer, SiReactrouter,]
        ,Tech:['reactjs','javascript','css', 'Framer-motion','vanilla-react']
